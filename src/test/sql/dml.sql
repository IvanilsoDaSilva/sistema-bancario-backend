...
LOCK TABLES `sistema_bancario_backend_teste`.`address` READ;
	START TRANSACTION;
		INSERT INTO `sistema_bancario_backend_teste`.`address` (
			...
			('000', '2020-01-01', '2020-01-01', 'BRASIL', 'RJ', 'RIO DE JANEIRO', 'COPACABANA', 'AVENIDA ATLÂNTICA', '100', '22070-000', `sistema_bancario_backend_teste`.`FORMAT`('  perto da praia  ')), -- Function
