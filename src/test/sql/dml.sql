...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`address` READ;
	START TRANSACTION;
		INSERT INTO `sistema_bancario_backend_teste`.`address` (
			...
			('000', '2020-01-01', '2020-01-01', 'BRASIL', 'RJ', 'RIO DE JANEIRO', 'COPACABANA', 'AVENIDA ATLÂNTICA', '100', '22070-000', `sistema_bancario_backend_teste`.`FORMATER`('  perto da praia  ')), -- Function
...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`agency` READ;
	START TRANSACTION;
...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`individual_person` READ;
	START TRANSACTION;
...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`legal_person` READ;
	START TRANSACTION;
...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`account` READ;
	START TRANSACTION;
...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`log` READ;
	START TRANSACTION;
...
-- -----------------------------------------------------
LOCK TABLES `sistema_bancario_backend_teste`.`operation` READ;
	START TRANSACTION;
...
LOCK TABLES `sistema_bancario_backend_teste`.`account` READ;
	START TRANSACTION;
		CALL ADJUSTMENT(2000.00, 0.00005); -- Procedure
	COMMIT;
	-- ROLLBACK;
UNLOCK TABLES;
-- SELECT * FROM `sistema_bancario_backend_teste`.`account`;
...
LOCK TABLES `sistema_bancario_backend_teste`.`view_pessoafisica_conta_endereco_agencia` WRITE;
...
LOCK TABLES `sistema_bancario_backend_teste`.`view_pessoajuridica_conta_endereco_agencia` WRITE;
...
LOCK TABLES `sistema_bancario_backend_teste`.`view_log_conta` WRITE;
...
LOCK TABLES `sistema_bancario_backend_teste`.`view_conta_operacao` WRITE;
...
LOCK TABLES `sistema_bancario_backend_teste`.`view_agencia_endereco` WRITE;
...
LOCK TABLES `sistema_bancario_backend_teste`.`view_agencia_quantidadepessoafisica_quantidadepessoajuridica` WRITE;
